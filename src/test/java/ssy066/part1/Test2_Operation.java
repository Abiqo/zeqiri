...
/**
 * Programming test 2. The code for test 2 i located in package ssy066.part1.operation
 * 
 * It is time to use the state that we created in test 1.
 * In this test we will work with predicates, conditions and operations. In later assignments we will
 * study graphs, which are essential data structures in many application. Especially in this
 * course. 
 *
 * 
 * @author Kristofer
...
public class Test2_Operation extends TestCase {
	 ...
	 */
	public void test1_PredicateEqual() {
	 ...
	 */
	public void test2_PredicateString(){
	 ...
	 */
	public void test3_PredicateAND() {
		Predicate p1 = new EQ(v1, 0);
		Predicate p2 = new EQ(v2, true);
	 ...
	 */
	public void test7_AssignAction() {
	 ...
	 * We create it by sending in a name, one guard predicate, and a list of actions (newState predicates)
	 * 
	 * Implement the eval method to evaluate the guards
	 */
	public void test8_OperationEvaluate() {
		Predicate p1 = new EQ(v1, 0);
		...
		System.out.println("test8: " + o1.conditionAsString());
		System.out.println("test8: " + o2.conditionAsString());
	 ...
	 */
	public void test9_OperationExecute() {
		Action a1 = new Next(v1, 1);
     ...
     * based on the updated state. If operation execute is correct, then this
	 * should just pass.
     */
    public void test10_OperationExecute2() {
     ...
     * actions. If execute is correct, this should just pass.
     */
    public void test11_OperationExecution3() {
        Action a1 = new Next(v1, 1);
        Action a2 = new Next(v1, 2);
        Predicate p1 = new EQ(v1, 0);
